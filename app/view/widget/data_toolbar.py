...
class DataToolBar(ToolBar):
    ...
    def __init__(self, title, subtitle, parent=None):
        ...
        self.openDataButton = PushButton(
            self.tr('Documentation'), self, FluentIcon.DOCUMENT)
        self.separator = SeparatorWidget(self)
        self.toFirstButton = PrimaryPushButton("1", self)
        self.toNextButton = PrimaryPushButton("N", self)
        self.toPreviousButton = PrimaryPushButton("p", self)
